...
namespace CarStand.Persistence.Migrations
{
    /// <inheritdoc />
    public partial class Initial1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarsDescriptions", x => x.CarDescriptionID);
                    table.ForeignKey(
                        name: "FK_CarsDescriptions_Cars_CarID",
                        column: x => x.CarID,
                        principalTable: "Cars",
                        principalColumn: "CarID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarsDescriptions_CarID",
                table: "CarsDescriptions",
                column: "CarID");
        }
